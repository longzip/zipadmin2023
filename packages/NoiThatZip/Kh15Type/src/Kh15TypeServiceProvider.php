...
namespace NoiThatZip\Kh15Type;

use Illuminate\Support\ServiceProvider;

class Kh15TypeServiceProvider extends ServiceProvider
{
    /**
    ...
    {
        $this->mergeConfigFrom(__DIR__.'/../config/kh15type.php', 'kh15type');

        // Register the service the package provides.
        $this->app->singleton('kh15type', function ($app) {
            return new Kh15Type;
        });
    }
    ...
    protected function bootForConsole()
    {
        ...
        // $this->publishes([
        //     __DIR__.'/../config/kh15type.php' => config_path('kh15type.php'),
        // ], 'kh15type.config');
