...
namespace NoiThatZip\SalesTarget;

use Illuminate\Support\ServiceProvider;

class SalesTargetServiceProvider extends ServiceProvider
{
    /**
    ...
    {
        $this->mergeConfigFrom(__DIR__.'/../config/salestarget.php', 'salestarget');

        // Register the service the package provides.
        $this->app->singleton('salestarget', function ($app) {
    ...
    protected function bootForConsole()
    {
        ...
        $this->publishes([
            __DIR__.'/../config/salestarget.php' => config_path('salestarget.php'),
        ], 'salestarget.config');
