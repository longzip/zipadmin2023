...
export default {
    data() {
        return {
            ...
            uri: '/api/contacts-costcenters-targets',
        }
    },
    methods: {
        updateKh15s() {
            this.uri = '/api/leads-costcenters-targets';
            this.loadSalesTarget();
        },
        updateKHTN() {
            this.uri = '/api/contacts-costcenters-targets';
            this.loadSalesTarget();
        },
        updateOrders() {
            this.uri = '/api/orders-costcenters-targets';
            this.loadSalesTarget();
        },
        updateAmount() {
            this.uri = '/api/orders-costcenters-targets-2';
            this.loadSalesTarget();
        },
        loadSalesTarget() {
            this.$Progress.start();
