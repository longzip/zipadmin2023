                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                <label>Tiêu Đề</label>
                                <input v-model="form.address" type="text" class="form-control" :placeholder=" form.decision.sapo " disabled="true">
                            </div>
                    ...
                    <div class="card-footer">
                        ...
                        <button @click.prevent="editContact" class="btn btn-primary">Cập nhật</button>
                    </div>
                </div>
            </div>
        </div>
...
export default {
    ...
    methods: {
        ...
        editContact() {
            this.form.put('/api/bienban/' + this.id)
                .then(response => {
