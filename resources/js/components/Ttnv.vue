        ...
        <div class="card card-primary card-outline">
          <div class="card-body box-profile">
            ...
            <ul class="list-group list-group-unbordered mb-3">
              ...
              <li class="list-group-item">
                <b>SR</b> <a class="float-right">{{showroom}}</a>
              </li>
            </ul>
...
export default {
    ...
    methods: {
        loadcontact() {   
            axios.get("/api/showinfonv?id=" + this.$route.query.id + '&costcenters=' + this.$route.query.costcenters + '&user=' + this.$route.query.user)
                .then(response => {
                    this.contact = response.data.kh;
                    this.lead = response.data.lead;
                    this.showroom = response.data.showroom;
                });
        },
    },
    created() {
