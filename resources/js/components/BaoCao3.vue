...
export default {
    data() {
        return {
            ...
            uri: 'api/contacts-count-by-sale',
        }
    },
    methods: {
        searchdata() {
        ...
        loadSales() {
            ...
            axios.get(this.uri + '?' + dates_para + '&' +userIds+ '&' +showroomIds)
                .then(responsive => {
        ...
        updateKHTN() {
            this.uri = 'api/contacts-count-by-sale'
            this.loadSales();
        },
        updateKh15s() {
            this.uri = 'api/leads-count-by-sale';
            this.loadSales();
        },
        updateOrders(){
            this.uri = 'api/orders-count-by-sale';
            this.loadSales();
        },
        updateAmount(){
            this.uri = 'api/orders-amount-by-sale';
            this.loadSales();
        }
    },
    async mounted() {
