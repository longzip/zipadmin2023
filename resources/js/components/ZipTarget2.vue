<template>
    <div class="container">
        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Bang target cho Showrooms</h3>
                <div class="card-tool">
    ...
    data() {
        return {
            ...
            ranges: { //default value for ranges object (if you set this to false ranges will no be rendered)
                'P1': [moment('2019-01-01').startOf('week'), moment('2019-01-28')],
                'P2': [moment('2019-01-29').startOf('week'), moment('2019-02-25')],
                'P3': [moment('2019-02-26').startOf('week'), moment('2019-03-25')],
                'P4': [moment('2019-03-26').startOf('week'), moment('2019-04-22')],
                'P5': [moment('2019-04-23').startOf('week'), moment('2019-05-20')],
                'P6': [moment('2019-05-21').startOf('week'), moment('2019-06-17')],
                'P7': [moment('2019-06-18').startOf('week'), moment('2019-07-15')],
                'P8': [moment('2019-07-16').startOf('week'), moment('2019-08-12')],
                'P9': [moment('2019-08-13').startOf('week'), moment('2019-09-09')],
                'P10': [moment('2019-09-10').startOf('week'), moment('2019-10-07')],
                'P11': [moment('2019-10-08').startOf('week'), moment('2019-11-04')],
                'P12': [moment('2019-11-05').startOf('week'), moment('2019-12-02')],
                'P13': [moment('2019-12-03').startOf('week'), moment('2019-12-30')],
            },
            startDate: moment('2019-07-14').format().slice(0, 10),
            endDate: moment('2019-07-16').add(4, 'week').endOf('week').format().slice(0, 10),
            selectedDate: {
                startDate: moment('2019-07-14').format(),
                endDate: moment('2019-07-16').add(4, 'week').endOf('week').format()
            },
            uri: '/api/contacts-zip-targets',
        }
    },
    methods: {
        updateKh15s() {
            this.uri = '/api/leads-zip-targets';
            this.loadSalesTarget();
        },
        updateKHTN() {
            this.uri = '/api/contacts-zip-targets';
            this.loadSalesTarget();
        },
        updateOrders() {
            this.uri = '/api/orders-zip-targets';
            this.loadSalesTarget();
        },
        updateAmount() {
            this.uri = '/api/orders-zip-targets-2';
            this.loadSalesTarget();
        },
        loadSalesTarget() {
            this.$Progress.start();
