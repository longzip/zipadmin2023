            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-footer">
                        ...
                        <button @click.prevent="addContact" class="btn btn-primary">Tạo</button>
                    </div>
                </div>
            </div>
        </div>
...
export default {
    ...
    methods: {
        cancelContact() {
            location.replace('/dai-ly');
        },
        addContact() {
            console.log(this.form);
            this.form.post('/api/daily')
                .then(response => {
                    this.$router.push({ name: 'ttkhachdaily', query: { id: response.data.id } });
                })
                .catch(() => {
