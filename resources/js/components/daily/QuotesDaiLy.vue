                        ...
                        <div class="invoice p-3 mb-3">
                            ...
                            <div class="row invoice-info">
                                ...
                                <div class="col-sm-3 invoice-col">
                                    Người Đại Diện 
                                    <address>
                                        <strong>{{contact.title}}: {{contact.last_name}}</strong><br>
                                        Địa chỉ:{{contact.address}}<br>
                                        Điện thoại: <strong>{{contact.phone}}</strong>
                                    </address>
                                </div>
                                <!-- /.col -->
                            </div>
...
export default {
    ...
    methods: {
        ...
        loadContact() {
            axios.get('/api/daily/' + this.contactId)
                .then(response => {
        ...
        taobaogia() {
            ...
            axios.put('/api/daily/' + this.contact.id + '/quotes', {
                ...
                .then(response => {
                    this.$router.push({ name: 'ttkhachdaily', params: { id: this.contactId } });
                })
                .catch(error => {
                    swal.fire({
                        type: 'error',
