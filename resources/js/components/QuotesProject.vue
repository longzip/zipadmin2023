                        ...
                        <div class="invoice p-3 mb-3">
                            ...
                            <div class="row invoice-info">
                                <div class="col-sm-6 invoice-col">
                                    ...
                                    <strong>{{contact.company.name_company}}</strong><br>
                                    <strong>{{contact.company.sapo}}</strong>
                                </div>
                                <!-- /.col -->
                                <div class="col-sm-3 invoice-col">
                                    Thông Tin Khách Hàng 1
                                    <address>
                                        <strong>{{contact.company.chucdanh_one}}: {{contact.company.name_one}}</strong><br>
                                        Địa chỉ:{{contact.company.address_one}}<br>
                                        Điện thoại: <strong>{{contact.company.phone_one}}</strong>
                                    </address>
                                </div>
                                <div class="col-sm-3 invoice-col" v-if="contact.company.name_two != null">
                                    Thông Tin Khách Hàng 2
                                    <address>
                                        <strong>{{contact.company.chucdanh_two}}: {{contact.company.name_two}}</strong><br>
                                        Địa chỉ:{{contact.company.address_two}}<br>
                                        Điện thoại: <strong>{{contact.company.phone_two}}</strong>
                                    </address>
                                </div>
                                <!-- /.col -->
                            </div>
...
export default {
    ...
    methods: {
        ...
        loadContact() {
            axios.get('/api/project/' + this.contactId)
                .then(response => {
        ...
        taobaogia() {
            ...
            axios.put('/api/project/' + this.contact.id + '/quotes', {
                ...
                .then(response => {
                    this.$router.push({ name: 'ttkhachduan', params: { id: this.contactId } });
                })
                .catch(error => {
                    swal.fire({
                        type: 'error',
