                ...
                <div class="invoice p-3 mb-3">
                    ...
                    <div class="row invoice-info">
                        ...
                        <div class="col-sm-4 invoice-col">
                            Đến
                            <address>
                                Công Ty:<strong>{{ quote.company }}</strong>, tại:<strong>{{ quote.contact_city }}</strong><br>
                                Người Liên Hệ:<br>
                                <strong>{{ quote.company_name_one }}</strong><br>
                                Chức Danh: {{ quote.company_chucdanh_one }}  <br>
                                Phone: {{ quote.company_phone_one }}<br>
                                Email: {{ quote.company_email_one }}
                            </address>
                        </div>
                        <!-- /.col -->
                        <div class="col-sm-4 invoice-col">
...
export default {
    ...
    methods: {
        convertToOrder(quote) {
            axios.put('/quotes/session/' + quote.id)
                .then(() => {
                    this.$router.replace({ name: 'taoDon', params: { name: this.quote.company_name_one, phone: this.quote.company_phone_one, address: this.quote.company_address_one } })
    ...
    created() {
        axios.get('api/quotesDA/' + this.quoteId)
            .then(res => {
