    ...
    <body>
        <div class="flex-center position-ref full-height">
            ...
            <div class="content">
                ...
                <div class="links">
                    {{-- 
                    <a href="cashiers">Import Cashier</a>
                    <a href="customers">Import Customer</a>
                    <a href="sales">Import Sale</a>
                    <a href="salesorders">Import Sale Order</a>

                    <a href="orders">Import Order</a> --}}
